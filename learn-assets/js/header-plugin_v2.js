(function($) {
    $.gdHeader = function(element, options) {
        var defaults = {
            ...
            definitionUrl: "https://www.gooddata.com/learn-assets/js/header-definition_v2.json",
            customHeader: {}
        }
        ...
        var prepareLink = function(link) {
            var linkContainer = $(document.createElement("li")).addClass("gd-header-link-item"),
                linkElem = $(document.createElement("a")).addClass("gd-header-link").attr("href", link.link).text(link.title);

            if(isCurrentHome(link)) {
                linkContainer.addClass("gd-header-link-active");
            }
            ...
            if(link.title === "Learn") {
              linkContainer.addClass("gd-header-link-hub");
            }
        ...
        var prepareMobileMenuTrigger = function(links) {
            ...
            return [
                ...
                .addClass("gd-header-mobile gd-header-mobile-icon")
                .attr({
                  "src": currentHome[0].icon,
                  "alt": currentHome[0].title
                }),
                $(document.createElement("span"))
                    .addClass("gd-header-mobile gd-header-mobile-title")
                    .text(currentHome[0].title)
                    .get(0),
